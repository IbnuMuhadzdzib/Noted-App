        ...
        actions: [
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              padding:
                  const EdgeInsets.all(6), // atur seberapa besar lingkarannya
              backgroundColor: context.color.primary, // ganti sesuai tema lo
              elevation: 0,
            ),
            child: const Icon(
              Icons.add,
              ...
              ? const Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text(
                        'Add a note by tap on the + button above',
                        style: TextStyle(
                          fontSize: 16,
                          color: Colors.grey,
                        ),
